...
public:
     ...
     *    want in the string
     */
    std::string getVerticalText(bool withUnit=true, uint prec=1) const;
     ...
     *    want in the string
     */
    std::string getHorizontalText(bool withUnit=true, uint prec=1) const;
     ...
     *    want in the string
     */
    std::string getWindText(bool withUnit=true, uint prec=1) const;
     ...
     */
    static std::string getUnitText(speedUnit unit);
